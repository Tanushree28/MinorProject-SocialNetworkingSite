	  ...
	  <span></span><img src="images/about-img.png" alt=""><span></span>
	   ...
	   <div class="container">
		 ...
		 <div class="col-md-4 about-grids">
			 ...
			 <p>Vacation is a time to relax in safe surroundings.For emergency aid of any kind, call 100 from any phone... in your hotel, dial 9-10.</p>
...
<?php }?>
	...
	<div class="col-md-3 image-grid">
					 <img src="Admin/addverimages/PATHIKA.png" width="300px" height="150px" >

					 <p><a href="https://pathika.com/">Brought To You By Pāthika</a></p>
				 </div>
				<?php if($n%4==3)
				{?>
            </div>
...
Our travel experts can help you find the best agencie!</h4>

		  <div class="contact-grids">
			  <div class="container">
				  <div class="col-md-4 address">
						<h4 style="color:#09F">PATHIKA</h4>
						<p style="color:#000">NEED HELP FINDING TRAVEL AGENCIES <br/>
                        For fantastic suggestions you may also call our travel expert</p>
						<h5 style="color:#000"><span class="img1"></span>(+977) 9849901036&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;9874561230</h5>
						<h5 style="color:#000"><span class="img2"></span><a href="#">www.pathika.com&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;www.pathika.com</a></h5>
						<h5 style="color:#000"><span class="img3"></span>Chakupat, Lalitpur, Nepal</h5>
                        <br/>
